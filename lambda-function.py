...
lst7 = [(19542209, "New York"), (4887871, "Alabama"), (1420491, "Hawaii"), (626299, "Vermont"),
        (1805832, "West Virginia"), (39865590, "California")]
lst7a = sorted(lst7, key=lambda x: x[1][-1])
print(lst7a)

# 8
# Using sorted() function, reverse parameter and lambda sort the tuples in the list based
# on the last character of the second items in reverse order.
lst8 = [(19542209, "New York"), (4887871, "Alabama"), (1420491, "Hawaii"), (626299, "Vermont"),
        (1805832, "West Virginia"), (39865590, "California")]
# Type your answer here.
lst8a = sorted(lst8, key=lambda x: x[1][-1], reverse=True)
print(lst8a)

# Write a Python program to find the elements of a given list of strings that contain
# a specific substring using lambda. Go to the editor
